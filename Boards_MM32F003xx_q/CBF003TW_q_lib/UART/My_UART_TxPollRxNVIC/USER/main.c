...
{
    vUART2TxProcess.type     = emType_Polling;
...
int main(void)
{
    ...
    InitSystick();
		...
		GPIO_ConfigInit();
		//MY_GpioInit();
		//GPIO_ResetBits(GPIOB, GPIO_Pin_0);             //将PB0拉高,D3082EHY8就会一直有信号...?...
		//GPIO_ResetBits(GPIOA, GPIO_Pin_4);               //将PA4拉高,D3082EHY8就会一直有信号...?...
		//***************************************
